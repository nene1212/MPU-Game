...
#define SCL PCout(14) //串行时钟
#define SDA PCout(15) //串行数据
...
void IIC_Start1(void);// -- 开启I2C总线
void IIC_Stop1(void);// -- 关闭I2C总线
...
void Draw_Point1(unsigned char x,unsigned char y);
void Clear_Point1(unsigned char x,unsigned char y);
